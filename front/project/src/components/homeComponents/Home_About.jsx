...
>
  {aboutImages.map((item, index) => (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-r from-black/50 to-[#7F00FF]/30 z-0" />
      <div className="relative z-10 p-4 text-white h-full flex flex-col justify-end">
        ...
        <button
          ...
          className="self-start bg-gradient-to-r from-[#7F00FF] to-[#E100FF] text-white px-4 py-2 rounded-full text-sm hover:opacity-90 transition"
        >
          Learn More
        </button>
      </div>
